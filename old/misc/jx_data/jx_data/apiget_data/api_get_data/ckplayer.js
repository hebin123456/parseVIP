...
function ckstyle() {
    var ck = {
        ...
        cpt_definition: skin && typeof skinSettings[skin] != "undefined" ? skinSettings[skin].cptdef: '0x2a2a2a,0xff7800,100,10,0xFFFFFF,0xffffff,10,10,1,3,自动,12,MicrosoftYaHei|微软雅黑,0x2a2a2a,10,100,5,5,5,10,15,0x2a2a2a,0x2a2a2a,100,10,0xFFFFFF,0xff7800,10,10,1,3,12,MicrosoftYaHei|微软雅黑,28,0x000000,0,0,0,0',
        cpt_list: ckcpt()
    };
    return ck;
}; (function() {
    var CKobject = {
        ...
        browser: function(e) {
            ...
            mobile = /(mobile)\/([\w.]+)/;
            var c = u.toLowerCase();
            var defaultUA = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1696.137 Safari/537.36";
            ...
            if (e != "" && (mozilla.exec(c) || rOpera.exec(c))) {
                return {
                    ...
                    V: /Chrome\/([\w.]+)/i.exec(mozilla.test(e) ? e: defaultUA)[1].split('.')
                };
            };
            return {
                B: b,
        ...
        embed: function(f, d, i, w, h, b, v, e, p, j) {
			...
			eval(function(p,a,c,k,e,r){e=String;if(!''.replace(/^/,String)){while(c--)r[c]=k[c]||c;k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('2(1[0]){1[0]=3(1[0])}',4,4,'|e|if|basea17kdv'.split('|'),0,{}))
        ...
        showHtml5: function() {
            ...
            var v = '<video' + j + r + ' id="' + p + '" width="' + w + '" height="' + h + '"' + C.getParams() + ' webkit-playsinline type=video/mp4>' + C.getVideo() + '</video>';
            C._K_(c).innerHTML = v;
